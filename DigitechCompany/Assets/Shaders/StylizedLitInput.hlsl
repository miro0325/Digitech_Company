...
float _MedThreshold;
float _MedSmooth, _ShadowThreshold, _ShadowSmooth, _ReflectThreshold, _ReflectSmooth;
float _SpecularThreshold, _SpecularSmooth, _SpecularIntensity, _FresnelThreshold, _FresnelSmooth, _FresnelIntensity;
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
    ...
    UNITY_DOTS_INSTANCED_PROP(float4, _MedColor)
