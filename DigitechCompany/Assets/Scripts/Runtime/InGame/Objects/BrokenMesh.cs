...
public class BrokenMesh : MonoBehaviour
{
    ...
    {
        this.Invoke(() => DestroyMesh(), Random.Range(0.15f, 0.25f));
    }

    public void DestroySmallMesh()
    {
        Destroy(gameObject, Random.Range(1.25f, 2.5f));
        //this.Invoke(() => Destroy(gameObject), Random.Range(1.25f, 2.5f));
    }
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(BrokenMesh original)
        {
