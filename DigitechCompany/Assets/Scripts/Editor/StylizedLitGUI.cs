...
//            public MaterialProperty reflectThreshold;
//            public MaterialProperty reflectSmooth;
//            public MaterialProperty reflectBrushStrength;
...
//            public MaterialProperty reflectProbeIntensity;
//            public MaterialProperty metalReflectProbeIntensity;
//            public MaterialProperty reflectRotation;
...
//                reflectThreshold = BaseShaderGUI.FindProperty("_ReflectThreshold", properties, false);
//                reflectBrushStrength = BaseShaderGUI.FindProperty("_ReflectBrushStrength", properties, false);
...
//                reflectProbeIntensity = BaseShaderGUI.FindProperty("_ReflectProbeIntensity", properties, false);
//                metalReflectProbeIntensity = BaseShaderGUI.FindProperty("_MetalReflectProbeIntensity", properties, false);
//                reflectRotation = BaseShaderGUI.FindProperty("_ReflectRotation", properties, false);
//            }
//        }
...
//        {
//            materialEditor.TexturePropertySingleLine(StStyles.heightMapText, properties.parallaxMapProp,
...
//        {
//            materialEditor.ShaderProperty(properties.clearCoat, StStyles.clearCoatText);
//            var coatEnabled = material.GetFloat("_ClearCoat") > 0.0;

//            EditorGUI.BeginDisabledGroup(!coatEnabled);
//            {
//                materialEditor.TexturePropertySingleLine(StStyles.clearCoatMaskText, properties.clearCoatMap, properties.clearCoatMask);

//                EditorGUI.indentLevel += 2;

//                // Texture and HDR color controls
//                materialEditor.ShaderProperty(properties.clearCoatSmoothness, StStyles.clearCoatSmoothnessText);
...
//                smoothnessChannelNames = StStyles.metallicSmoothnessChannelNames;
//                materialEditor.TexturePropertySingleLine(StStyles.metallicMapText, properties.metallicGlossMap,
//                    hasGlossMap ? null : properties.metallic);
//            }
//            else
//            {
//                hasGlossMap = properties.specGlossMap.textureValue != null;
//                smoothnessChannelNames = StStyles.specularSmoothnessChannelNames;
//                BaseShaderGUI.TextureColorProps(materialEditor, StStyles.specularMapText, properties.specGlossMap,
...
//            materialEditor.ShaderProperty(smoothness, StStyles.smoothnessText);
...
//                    smoothnessSource = EditorGUILayout.Popup(StStyles.smoothnessMapChannelText, smoothnessSource, smoothnessChannelNames);
...
//                    EditorGUILayout.Popup(StStyles.smoothnessMapChannelText, 0, smoothnessChannelNames);
//                    EditorGUI.EndDisabledGroup();
//                }
